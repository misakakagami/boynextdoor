...
<a href="/useCase/useCaseDetail<#if useCaseId?? || exampleListOutDto.useCaseId??>?useCaseId=${useCaseId!exampleListOutDto.useCaseId}</#if>">
    ...
    <div id="iframe_home" class="iframe cur">
        <div class="table-responsive">
            ...
            <tr>
                ...
                <td>${ex.exampleId}</td>
                <td>${ex.exampleName}</td>
                <td><#if ex.exampleStatus?? && ex.exampleStatus == -1>
                ...
                <td>${ex.exampleUrl}</td>                
                <td>${ex.createTime?string('YYYY-MM-dd')}</td>
                <td>${ex.updateTime?string('YYYY-MM-dd')}</td>
                 <td>${ex.createUserId}</td>               
                  <td>
                     <a href="/useCase/downloadExample?exampleId=${ex.exampleId}"><button type="button" class="btn btn-info btn-xs">下载</button></a>              
                  </td>
            </tr>            
            </tbody>
            </#list>
