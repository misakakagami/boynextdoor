	      ...
	      <div class="form-group">
           ...
           <br>
					...
					<p>
						...
						<button class="btn btn-primary">即时执行</button>
						<button class="btn btn-primary">定时执行</button>
						<button class="btn btn-primary">停止执行</button>
					</p>
								...
								<table class="table table-bordered table-hover"
									...
									<tbody>
										<tr>
											...
											<td>2018-05-10</td>
											<td>2018-05-11</td>
											<td><a href="planDetail.jsp"><button
