	 ...
	 <!-- 用例详情 -->
											<div class="profile-user-info profile-user-info-striped" style="margin-left:80px;">
												...
												<div class="profile-info-row">
													...
													<div class="profile-info-value">
														<span class="editable" id="age">通知书模块</span>
													</div>
												</div>
												...
												<div class="profile-info-row">
													...
													<div class="profile-info-value">
														<span class="editable" id="signup">中台系统</span>
													</div>
												</div>
												...
												<div class="profile-info-row">
													<div class="profile-info-name"> 脚本路径</div>
           		...
           		<div class="profile-info-row">
													...
													<div class="profile-info-value">
														 <a href="example.jsp"><button type="button" class="btn btn-info btn-xs" >查询</button></a>&nbsp;&nbsp;&nbsp;
												 ...
												 <div class="profile-info-row">
													...
													<div class="profile-info-value">
														<a href="script.jsp"><button type="button" class="btn btn-info btn-xs">查询</button></a>&nbsp;&nbsp;&nbsp;
														 <a href="javascript:;" class="file">上传
															    <input type="file" name="" id="">
															</a>
													</div>
