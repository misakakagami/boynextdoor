	 ...
	 <!-- 测试案例详情 -->
											<div class="profile-user-info profile-user-info-striped" style="margin-left:80px;">
												<div class="profile-info-row">
													<div class="profile-info-name"> 案例id </div>
												...
												<div class="profile-info-row">
													<div class="profile-info-name"> 案例名称 </div>

														<div class="profile-info-value">
														<span class="editable" id="username">获取通知书详情</span>
													</div>
												</div>

												<div class="profile-info-row">
													<div class="profile-info-name"> 所属用例名称</div>

													<div class="profile-info-value">
														<span class="editable" id="age">获取通知书详情</span>
													</div>
												</div>

													<div class="profile-info-row">
													<div class="profile-info-name"> 配置名称</div>

													<div class="profile-info-value">
														<span class="editable" id="signup">配置名称</span>
													</div>
												</div>
												
												<div class="profile-info-row">
													<div class="profile-info-name"> 案例路径</div>

													<div class="profile-info-value">
														<span class="editable" id="about">www.baidu.com</span>
													</div>
												</div>
												
												
										<div class="profile-info-row">
													<div class="profile-info-name"> 案例类型</div>

													<div class="profile-info-value">
														<span class="editable" id="signup">接口</span>
													</div>
												</div>
												
												<div class="profile-info-row">
													<div class="profile-info-name"> 案例状态</div>
												...
												<div class="profile-info-row">
													<div class="profile-info-name"> 案例描述</div>

													<div class="profile-info-value">
														<span class="editable" id="signup">根据入参获取用例详细信息</span>
													</div>
												</div>
												
													<div class="profile-info-row">
													<div class="profile-info-name"> 案例创建时间</div>
													...
													<div class="profile-info-row">
													<div class="profile-info-name"> 案例修改时间</div>
												...
												<div class="profile-info-row">
													<div class="profile-info-name"> 案例创建人</div>
													...
													<div class="profile-info-row">
													<div class="profile-info-name"> 案例修改人</div>
    ...
    <div class="modal-dialog">
        <div class="modal-content message_align">
            <div class="modal-header">
                ...
                <h4 class="modal-title">修改测试案例</h4>
            </div>
            <div class="modal-body">
                <form class="form-horizontal" role="form">
                   <div class="form-group">
									...
									<div class="form-group">
										<label for="selectCar" class="col-sm-3 control-label">案例类型：</label>
										<div class="col-sm-9">
											<select name="" class="form-control" id="selectCar2">
