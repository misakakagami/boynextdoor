  ...
  <div class="form-group" style="padding-left:80px;">
	 ...
	 <!-- 项目详情 -->
											<div class="profile-user-info profile-user-info-striped" style="margin-left:80px;">
												...
												<div class="profile-info-row">
													<div class="profile-info-name"> 计划名称 </div>
														...
														<div class="profile-info-value">
														<span class="editable" id="username">获取项目详情</span>
													</div>
												</div>
												...
												<div class="profile-info-row">
													...
													<div class="profile-info-value">
														<span class="editable" id="age">离开多久放假了空间的开发</span>
													</div>
												</div>
           	...
           	<div class="profile-info-row">
													...
													<div class="profile-info-value">
														<span class="editable" id="signup">定时计划</span>
													</div>
												</div>
												...
												<div class="profile-info-row">
													...
													<div class="profile-info-row">
													<div class="profile-info-name"> 计划执行时间间隔</div>

													<div class="profile-info-value">
														<span class="editable" id="signup">2d</span>
													</div>
													</div>
           		...
           		<div class="profile-info-row">
													...
													<div class="profile-info-value">
														 <a href="testUseCaseDetail.jsp"><button type="button" class="btn btn-info btn-xs" >查询</button></a>&nbsp;&nbsp;&nbsp;
