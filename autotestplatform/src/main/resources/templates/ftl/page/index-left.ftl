    ...
    <div class="navbar navbar-default" id="navbar">
			...
			<div class="navbar-container" id="navbar-container">
				<div class="navbar-header pull-left">
					...
					<div class="navbar-header pull-right" role="navigation" style="width:200px;">
					<ul class="nav ace-nav">

						<li class="light-blue">
							<span class="user-info" >
								<h5 style="color:white">用户:[${(Session.loginUser.nickName)!'游客'}]&nbsp;&nbsp;&nbsp;<a style="color:white" href="/loginOut">退出</a></h5>
							</span>
						</li>
					</ul><!-- /.ace-nav -->
				</div><!-- /.navbar-header -->
