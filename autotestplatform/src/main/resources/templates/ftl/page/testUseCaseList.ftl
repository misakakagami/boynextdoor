				...
				<form class="form-inline" id="#" name="" method="get">
					...
					<div class="form-group">
						<label for="projectname">模块名称</label> <select id="select"
							style="width: 150px; heigth: 20px;" onchange="a()">
							<option value="1">产品平台</option>
							<option value="2">在线承保</option>
							<option value="3">通知书接口</option>
						</select> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					</div>


					<div class="form-group">
						<label for="planname">用例名称</label> <input type="text"
							id="planname" placeholder="请输入用例名称"
								...
								<table class="table table-bordered table-hover"
									...
									<tbody>									
										<tr>
											...
											<td>${uc.useCaseId}</td>
											<td><a href="/projectModel/getProjectDetail?projectDetailInDto.projectId=${uc.projectId}">${uc.projectName}</a></td>
											<td><a href="/projectModel/getModelDetail?modelDetailInDto.modelId=${uc.modelId}">${uc.modelName}</a></td>
											<td>${uc.useCaseName}</td>
											<td> <#if uc.useCaseStatus?? && uc.useCaseStatus == -1>
                                                <span style="color:red">弃用</span>
                                            <#else>
								                <span style="color:green">正常</span>
								            </#if></td>
											<td>${uc.useCaseType}</td>
											<td>${uc.updateTime?string('YYYY-MM-dd')}</td>
		                                     <form id="deleteUseCase${uc.useCaseId}">
											 <td><a href="/useCase/useCaseDetail?useCaseId=${uc.useCaseId}"><button
												...
												<a href="javascript:void(0)" onclick="submitDeleteUseCase('${uc.useCaseId}', '${uc.modelId}');return false;">	
												<button ng-click="delUser()" class="btn btn-info btn-xs"
													data-toggle="modal" data-target="#delModel">标记弃用</button></a></td>
											    </form>
										</tr>
									</tbody>
									</#list>
					...
					<div class="modal-dialog">
						<div class="modal-content message_align" style="width: auto;">
							...
							<div class="modal-body">
								<form class="form-horizontal" role="form" id="addUseCase">
									<div class="form-group">
										<label for="selectproject" class="col-sm-3 control-label">模块名称：</label>
										<div class="col-sm-9">
									...
									<div class="form-group">
										<label for="selectCar2" class="col-sm-3 control-label">用例名称：</label>
										<div class="col-sm-9">
											<input type="text" name="useCaseDto.useCaseName">
										</div>
									</div>
									<div class="form-group">
										<label for="selectCar" class="col-sm-3 control-label">用例类型：</label>
										<div class="col-sm-9">
											<select class="form-control" id="selectCar2" name="useCaseDto.useCaseType">
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<textarea rows="5" cols="50" name="useCaseDto.useCaseContent"></textarea>
										</div>
									</div>
								</form>
							</div>
							<div class="modal-footer">
								<a  onclick="submitAddUseCase()" class="btn btn-primary"
