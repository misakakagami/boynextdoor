		...
		<div class="profile-user-info profile-user-info-striped" style="margin-left:80px;">
			<div class="profile-info-row">
				...
				<div class="profile-info-value">
					<span class="editable" id="username">${modelDetailOutDto.modelId}</span>
				</div>
			</div>
			...
			<div class="profile-info-row">
				<div class="profile-info-name"> 项目名称 </div>
					...
					<div class="profile-info-value">
					<span class="editable" id="username">${modelDetailOutDto.projectName}</span>
				</div>
			</div>
			...
			<div class="profile-info-row">
				<div class="profile-info-name"> 模块名称 </div>
					...
					<div class="profile-info-value">
					<span class="editable" id="username">${modelDetailOutDto.modelName}</span>
				</div>
			</div>
			...
			<div class="profile-info-row">
				...
				<div class="profile-info-value">
					<span class="editable" id="age"><a href="${modelDetailOutDto.modelUrl}">模块地址</a></span>
				</div>
			</div>
			...
			<div class="profile-info-row">
				...
				<div class="profile-info-value">
					<span class="editable" id="signup">${modelDetailOutDto.modelStatus}</span>
				</div>
			</div>
				...
				<div class="profile-info-value">
					<span class="editable" id="signup">${modelDetailOutDto.createTime?string('yyyy-MM-dd')}</span>
				</div>
			</div>
				...
				<div class="profile-info-value">
					<span class="editable" id="signup">${modelDetailOutDto.updateTime?string('yyyy-MM-dd')}</span>
				</div>
			</div>
			...
			<div class="profile-info-row">
				...
				<div class="profile-info-value">
					<span class="editable" id="signup">${modelDetailOutDto.createUserId}</span>
				</div>
			</div>
				...
				<div class="profile-info-value">
					<span class="editable" id="signup">${modelDetailOutDto.updateUserId}</span>
				</div>
			</div>
