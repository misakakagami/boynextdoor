...
public class PlanResult implements Serializable {
    ...
    */
    ...
    public PlanResult(Integer planResultId, Integer planId, String planResultName, String planResultLogUrl,
                      Integer sumNum, Integer successNum, String warnFlag, Integer planResultStatus, Date createTime) {
        super();
