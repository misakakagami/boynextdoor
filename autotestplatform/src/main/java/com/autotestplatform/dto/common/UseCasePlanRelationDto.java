...
public class UseCasePlanRelationDto implements Serializable {
    ...
    */
    ...
    public UseCasePlanRelationDto() {
        super();
        // TODO Auto-generated constructor stub
    }

    public UseCasePlanRelationDto(Integer useCasePlanRelationId, Integer useCaseId, Integer planId,
                                  Integer planStatus) {
        super();
