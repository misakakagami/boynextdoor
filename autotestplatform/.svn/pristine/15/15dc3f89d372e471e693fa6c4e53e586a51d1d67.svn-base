...
public class Identity implements Serializable {
    ...
    */
    private static final long serialVersionUID = -2143128274106776681L;
    ...
    public Identity(Integer identityId, String identityName, Integer identityStatus, Date createTime, Date updateTime,
